    ...
    hlp.load(async function () {
        await $("#root").html(`
            ...
            <div class="flex flex-col gap-5 pt-[1.1rem] mb-[1.8rem] container mx-auto py-10 px-4">
                ...
                <div class="flex flex-col container mx-auto ${hlp.theme("theme-card")} rounded-xl py-3 px-3">
                    <div id="theme" class="flex flex-row justify-between container mx-auto cursor-pointer">
                        <div class="flex flex-row justify-center items-center gap-4 pointer-events-none">
                            ...
                            <div class="flex flex-col items-center">
                                <h1 class="text-[20px] font-bold">Color Theme</h1>
                            </div>
                        </div>
                ...
                <div class="flex flex-col container mx-auto ${hlp.theme("theme-card")} rounded-xl py-3 px-3">
                    ...
                    <div id="hide-excused" class="flex flex-row justify-between container mx-auto cursor-pointer pt-3">
                        ...
                        <div class="flex justify-center items-center">
                            ...
                            <label id="hide-excused" class="flex items-center cursor-pointer">
                                <div class="w-[3.7rem] h-[33px] ${hlp.theme("theme-toggle")} rounded-full pointer-events-none p-1">
                                    <div class="bg-white w-[25px] h-[25px] rounded-full shadow-md transform translate-x-0"></div>
                                </div>
                            </label>
                        </div>
                ...
                <div class="flex flex-col container mx-auto ${hlp.theme("theme-card")} rounded-xl py-3 px-3">
                    <div id="hide-lti-details" class="flex flex-row justify-between container mx-auto cursor-pointer">
                        ...
                        <div class="flex justify-center items-center">
                            ...
                            <label id="hide-lti-details" class="flex items-center cursor-pointer">
                                <div class="w-[3.7rem] h-[33px] ${hlp.theme("theme-toggle")} rounded-full pointer-events-none p-1">
                                    <div class="bg-white w-[25px] h-[25px] rounded-full shadow-md transform translate-x-0"></div>
                                </div>
                            </label>
        ...
        await $.each(settings, (i, setting) => {
            if (setting.$value) {
                ...
                $(`input[setting_name="${setting.setting}"]`).parent().find("label div>div").removeClass("translate-x-0").addClass("translate-x-full").parent().removeClass(`${hlp.theme("theme-toggle")}`).addClass(`${hlp.theme("bg", "700")}`);
            }
        })
